package fr.fabienhebuterne.marketplace.nms.v1_13_R2
...
object ItemStackReflection : IItemStackReflection {
    ...
    private fun updateToLatestMinecraft(item: NBTTagCompound, currentItemVersion: Int?): NBTTagCompound {
        val itemVersion: Int = currentItemVersion ?: DATA_VERSION_V1_12_R1
    ...
    override fun getVersion(): Int = DATA_VERSION_V1_13_R2
