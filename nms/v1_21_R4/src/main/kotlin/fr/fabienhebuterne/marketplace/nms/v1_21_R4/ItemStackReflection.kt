package fr.fabienhebuterne.marketplace.nms.v1_21_R4
...
object ItemStackReflection : IItemStackReflection {
    ...
    private const val DATA_VERSION_V1_21_R3 = 4189
    private const val DATA_VERSION_V1_21_R4 = 4325
    ...
    override fun deserializeItemStack(itemStackString: String, currentItemVersion: Int?): ItemStack {
        ...
        return CraftItemStack.asBukkitCopy(itemStackNMS.get())
    }
    ...
    private fun updateToLatestMinecraft(item: NBTTagCompound, currentItemVersion: Int?): NBTTagCompound {
        val itemVersion: Int = currentItemVersion ?: DATA_VERSION_V1_21_R3
        ...
        val result: Dynamic<NBTBase> = DataConverterRegistry.a().update(
            ...
            input,
            itemVersion,
            DATA_VERSION_V1_21_R4
        )
        return result.value as NBTTagCompound
    }

    override fun getVersion(): Int = DATA_VERSION_V1_21_R4
