package fr.fabienhebuterne.marketplace.nms.v1_20_R4
...
object ItemStackReflection : IItemStackReflection {
    ...
    private const val DATA_VERSION_V1_20_R3 = 3700
    ...
    private fun updateToLatestMinecraft(item: NBTTagCompound, currentItemVersion: Int?): NBTTagCompound {
        val itemVersion: Int = currentItemVersion ?: DATA_VERSION_V1_20_R3
        ...
        val result: Dynamic<NBTBase> = DataConverterRegistry.a().update(
            ...
            input,
            itemVersion,
            DATA_VERSION_V1_20_R4
        )
        return result.value as NBTTagCompound
    }

    override fun getVersion(): Int = DATA_VERSION_V1_20_R4
