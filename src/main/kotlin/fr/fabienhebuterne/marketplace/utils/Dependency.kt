...
class Dependency(var instance: JavaPlugin, var classLoader: ClassLoader) {

    val dependencies = mutableListOf("slf4j-api-1.7.30", "kotlin-stdlib-1.3.71", "kotlin-stdlib-jdk8-1.3.71",
