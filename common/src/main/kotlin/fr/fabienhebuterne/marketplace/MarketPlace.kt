...
class MarketPlace(override var loader: JavaPlugin) : BootstrapLoader {
    ...
    private fun initItemStackNms(): IItemStackReflection {
        ...
        if (minecraftVersion == "1.21.8-R0.1-SNAPSHOT") {
            return fr.fabienhebuterne.marketplace.nms.v1_21_R5.ItemStackReflection
        }

        if (minecraftVersion == "1.21.10-R0.1-SNAPSHOT") {
